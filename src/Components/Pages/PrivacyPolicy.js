    ...
    <>
      <div className="container " style={{ paddingTop: 10 }}>
        ...
        <div className="privacy_text">
            We, HardCipher Private Limited, are registered at B-3/17, First
          Floor, Model Town First, New Delhi - 110009 and headquartered Address
          - 1, hereinafter referred to as Dashback or DashBack or DB. At
          Dashback, we value your trust & respect your privacy. This Privacy
          Policy provides you with details about the manner in which your data
          is collected, stored & used by us. You are advised to read this
          Privacy Policy carefully. By downloading and using the Dashback
          application/ website/WAP site you expressly give us consent to
          collect, use & disclose your personal information in accordance with
          this Privacy Policy. If you do not agree to the terms of the policy,
          please do not use or access Dashback.
        </div>
        <div className="privacy_text">
        ...
        <div className="privacy_text">
          ...
          emails and/or SMS. Any emails and/or SMS sent by Dashback will only be
          in connection with the provision of agreed services & products and
          this Privacy Policy.
        </div>
        <div className="privacy_text">
        ...
        <div className="privacy_text">
          ...
          products, services, updates, customize your experience, detect &
        ...
        <div className="privacy_text">
          ...
          your previous orders and interests.      We may occasionally ask you
          to complete optional online surveys. These surveys may ask you for
          contact information and demographic information (like zip/PIN code,
          age, gender, etc.). We use this data to customize your experience at
        ...
        <div className="privacy_text">
          ...
          Dashback uses cookie and tracking technology depending on the features
          offered. No personal information will be collected via cookies and
        ...
        <div className="privacy_text">
               Dashback has stringent security measures in place to protect the
        ...
        <div className="privacy_text">
               By using Dashback and/or by providing your information, you
          consent to the collection and use of the information you disclose on
          Dashback in accordance with this Privacy Policy, including but not
          limited to your consent for sharing your information as per this
          privacy policy.
        </div>
        <div className="privacy_text">
               We are required to make an automated IVR or a manual verification
          call to the customer for registration or updates by time to time. You
          will receive this verification call even if your number is registered
          for the Do Not Disturb (DND) option with your mobile carrier.      For
        ...
        <div className="privacy_text">
             Address: HardCipher Private Limited, B-3/17, First Floor, Model
          Town First, Delhi-110009
        </div>
