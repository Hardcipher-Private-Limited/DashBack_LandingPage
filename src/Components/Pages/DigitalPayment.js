      ...
      <div className="container mb-5">
        ...
        <div className="col-lg-12 pt-4 row">
          ...
          <div className="col-lg-5 p-4">
            <div className="digital_card_text">
              ...
              <div className="sub_pargram">State of the Art Service</div>
              <p>
                A cutting-edge digital payments app in India that allows you to
                send and receive money instantly with just a few taps on your
                mobile device. With a user-friendly interface and lightning-fast
                processing times, DashBack is the ultimate payments solution for
                people on the go. In addition to its speed and convenience,
                DashBack offers a unique cashback program that rewards you for
                every transaction you make. Whether you're buying groceries,
                paying bills, or shopping for a new outfit, DashBack gives you
                up to 100% of your purchase amount back in cash.
              </p>
              <div className="sub_pargram"> Robust Security Protocols </div>
              <p>
                Your security is a top priority for us. At DashBack, we use
                advanced encryption technology to protect your information and
          ...
          <div className="col-lg-5 p-4 pt-5 padding_for_textss">
            <div className="digital_card_text " style={{ marginTop: "90px" }}>
              <p>
        ...
        >
          ...
          <div className="col-lg-5 Onling_textsss">
            <div className="digital_card_text" style={{ marginTop: "80px" }}>
              <p>
        ...
        >
          ...
          <div className="col-lg-5">
            <div className="digital_card_text">
              ...
              <h3>Effortless savings, increased benefits.</h3>
              <div>Secure Your Future With Ease</div>
              <p>
                DashBack offers its Premium Members the opportunity to grow
                their savings through two investment plans. 
              </p>
              <p>
                <b>Timed Plans:</b> These plans are designed to provide
                investors with a guaranteed return on investment at the end of a
                fixed term. They may be suitable for investors who want a fixed
                return and are comfortable committing their funds to the plan
                for a specific period. The amount of the return is typically
          ...
          <div className="col-lg-5 pt-5">
            <div className="digital_card_text padding_for_texts">
              <p>
                <b>Flexi-Term Plans: </b>These plans are designed to provide
                investors with more flexibility and the potential for higher
                returns. Unlike Timed Plans, Flexi-Term Plans do not have a
                fixed investment term. Instead, investors are free to withdraw
                their funds at any desired point after 15 days without any
                penalty, making these plans a more flexible option for those who
                may need access to their funds in the short term.
              </p>
              <p>
